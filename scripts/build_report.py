...
def main():
    ...
    callout(doc, "Assumption Zero transaction costs are used in the headline results, but one-way turnover is reported. This is material for Maximum Sharpe, whose average monthly rebalance turnover reached about 25% in equity and 25% in combined funds.", fill="FFF7E6", border=GOLD)
